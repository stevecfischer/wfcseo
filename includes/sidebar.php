                ...
                foreach( $property_master->property_names as $p ){
                    ...
                    <li ng-click="getProfile(<?php echo $propID; ?>)" class="dropdown wfc-web-property">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <li>
                                <a data-code="<?php echo $propID; ?>" data-toggle="modal" class="table-site-template" data-names="code" data-where="this" data-target="#property_dashboard">Edit Manual Data</a>
                                    <a data-code="<?php echo $propID; ?>" data-toggle="modal" class="view-metrics" data-action="ajax-right" data-names="code" data-where="this" data-target="viewmetrics">View Metrics</a>
                            </li>
                        </ul>
                    </li>
                <?php
