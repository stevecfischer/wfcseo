...
if (!defined('__CLASS_HTML2PDF__')) {
    ...
    require_once('html2pdf/exception.class.php');
    require_once('html2pdf/locale.class.php');
    require_once('html2pdf/myPdf.class.php');
    require_once('html2pdf/parsingHtml.class.php');
    require_once('html2pdf/parsingCss.class.php');
